...
public class CustomClassLoader extends ClassLoader {
   ...
   * This method could be changed to load the class over network from some other
   * server or from the database.
   *
   ...
   * super.loadClass() method which in turn will pass the request to the parent.
   *
   * @param name Full class name
   */
  @Override
